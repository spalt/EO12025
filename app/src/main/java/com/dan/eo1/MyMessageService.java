            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (message.startsWith("options")) {
                        ...
                        intent.putExtra("displayOption", Integer.parseInt(opts[4]));
                        intent.putExtra("customTag", String.valueOf(opts[5]));
                    }

                    if (message.startsWith("rawimage")) {
                        intent.putExtra("type", "rawimage");
                        String tmp[] = message.split(",");
                        intent.putExtra("filename", tmp[1]);
                        intent.putExtra("image", tmp[2]);
                    }
